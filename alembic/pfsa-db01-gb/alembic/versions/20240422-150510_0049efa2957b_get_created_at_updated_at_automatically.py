...
def upgrade():
    ...
    op.alter_column('filter_name', 'created_at',
    ...
    op.alter_column('filter_name', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was last updated',
               existing_comment='Update time [YYYY-MM-DDThh:mm:ss] (UTC)',
               existing_nullable=True)
    op.alter_column('fluxstd', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was created',
               existing_nullable=True)
    op.alter_column('fluxstd', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was last updated',
               existing_nullable=True)
    op.alter_column('input_catalog', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was created',
               existing_nullable=True)
    op.alter_column('input_catalog', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was last updated',
               existing_nullable=True)
    op.alter_column('proposal', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was created',
               existing_comment='Creation time [YYYY-MM-DDThh:mm:ss] (UTC or HST?)',
               existing_nullable=True)
    op.alter_column('proposal', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was last updated',
               existing_comment='Update time [YYYY-MM-DDThh:mm:ss] (UTC or HST?)',
               existing_nullable=True)
    op.alter_column('proposal_category', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was created',
               existing_comment='Creation time',
               existing_nullable=True)
    op.alter_column('proposal_category', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was last updated',
               existing_comment='Update time',
               existing_nullable=True)
    op.alter_column('sky', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was created',
               existing_nullable=True)
    op.alter_column('sky', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was last updated',
               existing_nullable=True)
    op.alter_column('target', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was created',
               existing_nullable=True)
    op.alter_column('target', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was last updated',
               existing_nullable=True)
    op.alter_column('target_type', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was created',
               existing_nullable=True)
    op.alter_column('target_type', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='The date and time in UTC when the record was last updated',
               existing_nullable=True)
