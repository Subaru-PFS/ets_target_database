...
| fiber_mag_u | double precision |  | true |  |  | u-band magnitude within a fiber (AB mag) |
| fiber_mag_v | double precision |  | true |  |  | v-band magnitude within a fiber (AB mag) |
...
| psf_mag_u | double precision |  | true |  |  | u-band PSF magnitude (AB mag) |
| psf_mag_v | double precision |  | true |  |  | v-band PSF magnitude (AB mag) |
...
| psf_mag_error_u | double precision |  | true |  |  | Error in u-band PSF magnitude (AB mag) |
| psf_mag_error_v | double precision |  | true |  |  | Error in v-band PSF magnitude (AB mag) |
...
| psf_flux_u | double precision |  | true |  |  | u-band PSF flux (nJy) |
| psf_flux_v | double precision |  | true |  |  | v-band PSF flux (nJy) |
...
| psf_flux_error_u | double precision |  | true |  |  | Error in u-band PSF flux (nJy) |
| psf_flux_error_v | double precision |  | true |  |  | Error in v-band PSF flux (nJy) |
...
| total_flux_u | double precision |  | true |  |  | u-band total flux (nJy) |
| total_flux_v | double precision |  | true |  |  | v-band total flux (nJy) |
...
| total_flux_error_u | double precision |  | true |  |  | Error in u-band total flux (nJy) |
| total_flux_error_v | double precision |  | true |  |  | Error in v-band total flux (nJy) |
...
| filter_u | varchar |  | true |  | [public.filter_name](public.filter_name.md) | u-band filter (u_sdss, u_cfht, u_skymapper, etc.) |
| filter_v | varchar |  | true |  | [public.filter_name](public.filter_name.md) | v-band filter (v_skymapper, v_splus, etc.) |
...
| target_filter_u_fkey | FOREIGN KEY | FOREIGN KEY (filter_u) REFERENCES filter_name(filter_name) |
| target_filter_v_fkey | FOREIGN KEY | FOREIGN KEY (filter_v) REFERENCES filter_name(filter_name) |
...
"public.target" }o--o| "public.filter_name" : "FOREIGN KEY (filter_u) REFERENCES filter_name(filter_name)"
"public.target" }o--o| "public.filter_name" : "FOREIGN KEY (filter_v) REFERENCES filter_name(filter_name)"
